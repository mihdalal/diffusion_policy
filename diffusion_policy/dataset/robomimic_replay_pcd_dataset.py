...
from diffusion_policy.dataset.base_dataset import BasePcdDataset, LinearNormalizer
...
class RobomimicReplayPcdDataset(BasePcdDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
        ...
        if n_obs_steps is not None:
            ...
            for key in rgb_keys + lowdim_keys + pcd_keys:
